      ...
      >
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} className="flex-row pb-2 -mx-6 px-6">
          <Pressable className="flex-row items-center gap-2 px-4 py-2 rounded-xl bg-card border border-border mr-3">
            ...
            <Text className="text-sm font-medium text-foreground" style={{ fontFamily: 'System' }}>Filters</Text>
          </Pressable>
          ...
          <View className="flex-1">
            <View className="flex-row items-start justify-between mb-2">
              ...
              <View className="px-2 py-1 rounded-lg bg-accent/10 ml-2">
                <Text className="text-accent text-xs font-medium">{deity}</Text>
              </View>
            </View>
            ...
            <View className="flex-row items-center gap-3 mb-2">
              <View className="flex-row items-center gap-1">
                ...
                <Text className="text-xs text-muted-foreground" style={{ fontFamily: 'System' }}>{temple}</Text>
              </View>
              <View className="flex-row items-center gap-1">
                <Clock size={14} color="#78716C" />
                <Text className="text-xs text-muted-foreground" style={{ fontFamily: 'System' }}>{duration}</Text>
              </View>
            </View>
